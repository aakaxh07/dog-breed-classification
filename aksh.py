...
training_set = train_datagen.flow_from_directory('/home/cloud/Desktop/dog-breed-identification/train',
                                                  target_size = (64, 64),
                                                  batch_size = 256,
...
test_set = test_datagen.flow_from_directory('/home/cloud/Desktop/dog-breed-identification/test',
                                              target_size = (64, 64),
...
model=model.fit_generator(training_set,
                                           ...
                                           samples_per_epoch = 20700,

                                           nb_epoch = 50,

                                           validation_data = test_set,

                                           nb_val_samples = 10357)
